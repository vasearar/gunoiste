...
export default function HowItWorks() {
  return (
    <section id="howitworks" className="w-full py-16 xl:py-0 h-fit xl:h-screen relative flex justify-center items-center px-4">
      <div className="flex flex-col items-center w-full">
        <h1 className="text-[#E86842] text-3xl lg:text-5xl font-medium mb-10 lg:mb-20 text-center">Cum asta lucrează?</h1>
        <div className="flex flex-col lg:flex-row justify-between items-center w-full px-16 xl:px-48 2xl:px-[22vw] text-nowrap">
          <div className="flex flex-col gap-4 lg:gap-9 text-base lg:text-2xl items-center font-bold">
            <Image 
              src="/envelope.png"
              alt="plic"
              width={100}
              height={100}
              className="w-[64px] lg:w-[100px] h-auto"
            />
            <p>Solicitare de colectare</p>
          </div>
          <svg className="lg:-mt-16 rotate-90 lg:rotate-0 my-4 lg:my-0 h-auto w-[30px] lg:w-[42px]" width="42" height="40" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex flex-col gap-4 lg:gap-9 text-base lg:text-2xl items-center font-bold">
            <Image 
              ...
              width={70}
              height={70}
              className="w-[44px] lg:w-[70px] h-auto"
            />
            <p>Stabilim ora</p>
          </div>
          <svg className="lg:-mt-16 rotate-90 lg:rotate-0 my-4 lg:my-0 h-auto w-[30px] lg:w-[42px]" width="42" height="40" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex flex-col gap-4 lg:gap-9 text-base lg:text-2xl items-center font-bold">
            <Image 
              ...
              width={130}
              height={100}
              className="w-[83px] lg:w-[130px] h-auto"
            />
